...
| BUG-010 | game / combat | Zobrazují se a jsou volitelné neplatné směry souboje — směr by měl být nabídnut pouze tehdy, pokud útočník dokáže dosáhnout na pole obránce v rámci zbývajícího pohybového dosahu         | P2 | otevřená | — |
| BUG-011 | Game / PlayerHUD | Zvýraznění tahu aktuálního hráče se někdy zobrazuje na špatné straně mapy — spolehlivě reprodukovatelné při procházení nastavením hráčů/mapy místo použití funkce přímé hry               | P2 | otevřená | — |
